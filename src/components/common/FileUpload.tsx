      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="flex flex-wrap gap-2 justify-center text-xs text-neutral-500">
            {accept.map((format) => (
              <span key={format} className="px-2 py-1 bg-neutral-100 rounded">
                {format}
              </span>
            ))}
          </div>
        ...
        <div className="mt-4 p-4 bg-white border border-neutral-200 rounded-xl">
          ...
          {success && (
            <div className="flex items-center gap-2 p-3 bg-primary-50 border border-primary-200 rounded-lg mb-3">
              ...
              <p className="text-sm text-primary-600">Upload successful!</p>
            </div>
          )}
          ...
          {!success && (
            <button
              ...
              className="w-full px-4 py-2 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 disabled:from-neutral-200 disabled:to-neutral-200 text-white disabled:text-neutral-500 font-medium rounded-lg transition-all duration-200 disabled:cursor-not-allowed"
            >
